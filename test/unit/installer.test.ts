...
const downloadUrls = {
  linux:
    'https://example.com/carvel-dev/ytt/releases/download/0.28.0/ytt-linux-amd64',
  win32:
    'https://example.com/carvel-dev/ytt/releases/download/0.28.0/ytt-windows-amd64.exe'
}
const downloadPaths = {
...
const expectedChecksums = {
  linux:
    '"dbd318c1c462aee872f41109a4dfd3048871a03dedd0fe0e757ced57dad6f2d7  ./ytt-linux-amd64"',
  win32:
    '"dbd318c1c462aee872f41109a4dfd3048871a03dedd0fe0e757ced57dad6f2d7  ./ytt-windows-amd64.exe"'
}
...
describe('Installer', () => {
  ...
  test('it installs a new app on nix systems', async () => {
    ...
    expect(core.info).toHaveBeenCalledWith(
      'Downloading ytt 0.28.0 from https://example.com/carvel-dev/ytt/releases/download/0.28.0/ytt-linux-amd64'
    )
    expect(core.info).toHaveBeenCalledWith(
      `✅  Verified checksum: "dbd318c1c462aee872f41109a4dfd3048871a03dedd0fe0e757ced57dad6f2d7  ./ytt-linux-amd64"`
    )
  ...
  test('it installs a new app on windows', async () => {
    ...
    expect(core.info).toHaveBeenCalledWith(
      'Downloading ytt 0.28.0 from https://example.com/carvel-dev/ytt/releases/download/0.28.0/ytt-windows-amd64.exe'
    )
    expect(core.info).toHaveBeenCalledWith(
      `✅  Verified checksum: "dbd318c1c462aee872f41109a4dfd3048871a03dedd0fe0e757ced57dad6f2d7  ./ytt-windows-amd64.exe"`
    )
  ...
  test('it verifies the checksums on nix systems', async () => {
    ...
    await expect(result).rejects.toThrowError(
      'Unable to verify checksum for ytt-linux-amd64. Expected to find "70f71fa558520b944152eea2ec934c63374c630302a981eab010e0da97bc2f24  ./ytt-linux-amd64" in release notes.'
    )
  })
  ...
  test('it verifies the checksums on windows', async () => {
    ...
    await expect(result).rejects.toThrowError(
      'Unable to verify checksum for ytt-windows-amd64.exe. Expected to find "70f71fa558520b944152eea2ec934c63374c630302a981eab010e0da97bc2f24  ./ytt-windows-amd64.exe" in release notes.'
    )
  })
})
